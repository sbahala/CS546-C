...
//app.use(middlewares.logAndRedirect);
app.use('/login',middlewares.redirectToHomeIfLoggedIn);
app.use('/register',middlewares.redirectToHomeIfLoggedInForRegister);
app.use('/protected', middlewares.ensureAuthenticatedForProtected);
app.use('/admin',middlewares.ensureAdmin);
app.use('/logout',middlewares.ensureLoggedInForLogOut);
